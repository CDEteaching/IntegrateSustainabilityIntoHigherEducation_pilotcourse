---
title: "Session 03 Reader: Education for Sustainable Development (ESD) & Constructive Alignment"
description: "Background reading that unpacks the core concepts from the Session 03 slides in more depth, with pointers into the Basics of Sustainability textbook where relevant."
navbar: false
---
...
This reader expands on the [Session 03 slides](../resources/slides/03_ESD_and_constructive_alignment_consolidated.pptx): it walks through the same concepts in more depth, with the reasoning and sources behind each slide spelled out. Use it to prepare, to revisit after the session, or as a stand-alone introduction if you are adapting this course and did not attend the live delivery. Also available as a [downloadable PDF](../resources/readers/week-03-reader.pdf){.material-link}.
